  ...
  "../../../../../setup-pnpm/node_modules/.bin/store/v11/links/@/probe-image-size/7.2.3/5c98b624d33ea215651dcdabccfe83eebfee774ae800e4250203ab6ed85a1abd/node_modules/probe-image-size/lib/miaf_utils.js"(exports, module) {
    ...
    module.exports.getMimeType = function(data) {
      ...
      if (brand === "avif" || brand === "avis" || brand === "avio") {
        return { mime: "image/avif", type: "avif" };
      }
      if (brand === "heic" || brand === "heix") {
        return { mime: "image/heic", type: "heic" };
      }
      if (brand === "hevc" || brand === "hevx") {
        return { mime: "image/heic-sequence", type: "heic" };
      }
      ...
      if (compat.heic || compat.heix || compat.hevc || compat.hevx || compat.heis) {
        if (compat.msf1) {
          return { mime: "image/heif-sequence", type: "heif" };
        }
        return { mime: "image/heif", type: "heif" };
      }
      return { mime: "image/avif", type: "avif" };
    };
  }
...
var require_avif = __commonJS({
  "../../../../../setup-pnpm/node_modules/.bin/store/v11/links/@/probe-image-size/7.2.3/5c98b624d33ea215651dcdabccfe83eebfee774ae800e4250203ab6ed85a1abd/node_modules/probe-image-size/lib/parse_stream/avif.js"(exports, module) {
    ...
    module.exports = function() {
      ...
      var sandbox = { fileType: null, offset: 0 };
      parser._bytes(8, function(data) {
        sandbox.offset += 8;
    ...
    function setup(env) {
      ...
      function createDebug(namespace) {
        ...
        function debug() {
          ...
          for (var _key = 0, _len = arguments.length, args = new Array(_len); _key < _len; _key++) {
...
var require_auth = __commonJS({
  "../../../../../setup-pnpm/node_modules/.bin/store/v11/links/@/needle/2.9.1/197a4b698eea2f6fc7fd30d14cb5f7a943b7e681a8f6e3c816b4c1e9b00fbf2c/node_modules/needle/lib/auth.js"(exports, module) {
    ...
    function get_header(header, credentials, opts) {
      var pass = credentials[1], type = header.split(" ")[0], user = credentials[0];
      if (type == "Digest") {
    ...
    digest.generate = function(header, user, pass, method, path) {
      var challenge = digest.parse_header(header), cnonce = null, nc = 1;
  ...
  "../../../../../setup-pnpm/node_modules/.bin/store/v11/links/@/sax/1.4.4/3673acdc939b13a78d08902df86197ea052cfddeb2090a71958fe72c8b1a3029/node_modules/sax/lib/sax.js"(exports) {
    (function(sax) {
      ...
      function newTag(parser) {
        ...
        var tag = parser.tag = { attributes: {}, name: parser.tagName };
        if (parser.opt.xmlns) {
          tag.ns = parent.ns;
        }
...
var require_parsers = __commonJS({
  "../../../../../setup-pnpm/node_modules/.bin/store/v11/links/@/needle/2.9.1/197a4b698eea2f6fc7fd30d14cb5f7a943b7e681a8f6e3c816b4c1e9b00fbf2c/node_modules/needle/lib/parsers.js"(exports, module) {
    ...
    function parseXML(str, cb) {
      var current, obj, parser = sax.parser(true, { lowercase: true, trim: true });
    ...
    function parserFactory(name, fn) {
      function parser() {
        ...
        stream._flush = function(done) {
          var data = Buffer.concat(chunks), self2 = this;
          try {
...
var require_internal = __commonJS({
  "../../../../../setup-pnpm/node_modules/.bin/store/v11/links/@/iconv-lite/0.4.24/870ab2f90f7127007bf0abb0c57f32d2f7c507616f4121b102ed4f0566e68438/node_modules/iconv-lite/encodings/internal.js"(exports, module) {
    ...
    module.exports = {
      ...
      cesu8: { bomAware: true, type: "_internal" },
      hex: { type: "_internal" },
      ucs2: { bomAware: true, type: "_internal" },
      unicode11utf8: "utf8",
      // Encodings
      utf8: { bomAware: true, type: "_internal" },
      utf16le: "ucs2"
    };
    ...
    InternalDecoderCesu8.prototype.write = function(buf) {
      var acc = this.acc, accBytes = this.accBytes, contBytes = this.contBytes, res = "";
    ...
    function detectEncoding(buf, defaultEncoding) {
      ...
      if (buf.length >= 2) {
        if (buf[0] == 254 && buf[1] == 255)
          ...
          var _len = Math.min(buf.length - buf.length % 2, 64), asciiCharsBE = 0, asciiCharsLE = 0;
...
var require_utf7 = __commonJS({
  "../../../../../setup-pnpm/node_modules/.bin/store/v11/links/@/iconv-lite/0.4.24/870ab2f90f7127007bf0abb0c57f32d2f7c507616f4121b102ed4f0566e68438/node_modules/iconv-lite/encodings/utf7.js"(exports) {
    ...
    Utf7Decoder.prototype.write = function(buf) {
      var base64Accum = this.base64Accum, inBase64 = this.inBase64, lastI = 0, res = "";
    ...
    Utf7IMAPEncoder.prototype.write = function(str) {
      var base64Accum = this.base64Accum, base64AccumIdx = this.base64AccumIdx, buf = Buffer2.alloc(str.length * 5 + 10), bufIdx = 0, inBase64 = this.inBase64;
...
var require_dbcs_codec = __commonJS({
  "../../../../../setup-pnpm/node_modules/.bin/store/v11/links/@/iconv-lite/0.4.24/870ab2f90f7127007bf0abb0c57f32d2f7c507616f4121b102ed4f0566e68438/node_modules/iconv-lite/encodings/dbcs-codec.js"(exports) {
    ...
    DBCSEncoder.prototype.write = function(str) {
      var i2 = 0, j = 0, leadSurrogate = this.leadSurrogate, newBuf = Buffer2.alloc(str.length * (this.gb18030 ? 4 : 3)), nextChar = -1, seqObj = this.seqObj;
      while (true) {
        if (nextChar === -1) {
    ...
    DBCSEncoder.prototype.end = function() {
      if (this.leadSurrogate === -1 && this.seqObj === void 0)
        return;
      var j = 0, newBuf = Buffer2.alloc(10);
      if (this.seqObj) {
...
var require_gb18030_ranges = __commonJS({
  "../../../../../setup-pnpm/node_modules/.bin/store/v11/links/@/iconv-lite/0.4.24/870ab2f90f7127007bf0abb0c57f32d2f7c507616f4121b102ed4f0566e68438/node_modules/iconv-lite/encodings/tables/gb18030-ranges.json"(exports, module) {
    module.exports = { gbChars: [0, 36, 38, 45, 50, 81, 89, 95, 96, 100, 103, 104, 105, 109, 126, 133, 148, 172, 175, 179, 208, 306, 307, 308, 309, 310, 311, 312, 313, 341, 428, 443, 544, 545, 558, 741, 742, 749, 750, 805, 819, 820, 7922, 7924, 7925, 7927, 7934, 7943, 7944, 7945, 7950, 8062, 8148, 8149, 8152, 8164, 8174, 8236, 8240, 8262, 8264, 8374, 8380, 8381, 8384, 8388, 8390, 8392, 8393, 8394, 8396, 8401, 8406, 8416, 8419, 8424, 8437, 8439, 8445, 8482, 8485, 8496, 8521, 8603, 8936, 8946, 9046, 9050, 9063, 9066, 9076, 9092, 9100, 9108, 9111, 9113, 9131, 9162, 9164, 9218, 9219, 11329, 11331, 11334, 11336, 11346, 11361, 11363, 11366, 11370, 11372, 11375, 11389, 11682, 11686, 11687, 11692, 11694, 11714, 11716, 11723, 11725, 11730, 11736, 11982, 11989, 12102, 12336, 12348, 12350, 12384, 12393, 12395, 12397, 12510, 12553, 12851, 12962, 12973, 13738, 13823, 13919, 13933, 14080, 14298, 14585, 14698, 15583, 15847, 16318, 16434, 16438, 16481, 16729, 17102, 17122, 17315, 17320, 17402, 17418, 17859, 17909, 17911, 17915, 17916, 17936, 17939, 17961, 18664, 18703, 18814, 18962, 19043, 33469, 33470, 33471, 33484, 33485, 33490, 33497, 33501, 33505, 33513, 33520, 33536, 33550, 37845, 37921, 37948, 38029, 38038, 38064, 38065, 38066, 38069, 38075, 38076, 38078, 39108, 39109, 39113, 39114, 39115, 39116, 39265, 39394, 189e3], uChars: [128, 165, 169, 178, 184, 216, 226, 235, 238, 244, 248, 251, 253, 258, 276, 284, 300, 325, 329, 334, 364, 463, 465, 467, 469, 471, 473, 475, 477, 506, 594, 610, 712, 716, 730, 930, 938, 962, 970, 1026, 1104, 1106, 8209, 8215, 8218, 8222, 8231, 8241, 8244, 8246, 8252, 8365, 8452, 8454, 8458, 8471, 8482, 8556, 8570, 8596, 8602, 8713, 8720, 8722, 8726, 8731, 8737, 8740, 8742, 8748, 8751, 8760, 8766, 8777, 8781, 8787, 8802, 8808, 8816, 8854, 8858, 8870, 8896, 8979, 9322, 9372, 9548, 9588, 9616, 9622, 9634, 9652, 9662, 9672, 9676, 9680, 9702, 9735, 9738, 9793, 9795, 11906, 11909, 11913, 11917, 11928, 11944, 11947, 11951, 11956, 11960, 11964, 11979, 12284, 12292, 12312, 12319, 12330, 12351, 12436, 12447, 12535, 12543, 12586, 12842, 12850, 12964, 13200, 13215, 13218, 13253, 13263, 13267, 13270, 13384, 13428, 13727, 13839, 13851, 14617, 14703, 14801, 14816, 14964, 15183, 15471, 15585, 16471, 16736, 17208, 17325, 17330, 17374, 17623, 17997, 18018, 18212, 18218, 18301, 18318, 18760, 18811, 18814, 18820, 18823, 18844, 18848, 18872, 19576, 19620, 19738, 19887, 40870, 59244, 59336, 59367, 59413, 59417, 59423, 59431, 59437, 59443, 59452, 59460, 59478, 59493, 63789, 63866, 63894, 63976, 63986, 64016, 64018, 64021, 64025, 64034, 64037, 64042, 65074, 65093, 65107, 65112, 65127, 65132, 65375, 65510, 65536] };
  }
});
    ...
    module.exports = function(iconv) {
      ...
      iconv.extendNodeEncodings = function extendNodeEncodings() {
        ...
        Buffer2.prototype.write = function(string, offset, length, encoding) {
          var _encoding = encoding, _length = length, _offset = offset;
          if (isFinite(offset)) {
            if (!isFinite(length)) {
              encoding = length;
              length = void 0;
...
var require_needle = __commonJS({
  "../../../../../setup-pnpm/node_modules/.bin/store/v11/links/@/needle/2.9.1/197a4b698eea2f6fc7fd30d14cb5f7a943b7e681a8f6e3c816b4c1e9b00fbf2c/node_modules/needle/lib/needle.js"(exports, module) {
    ...
    function parse_content_type(header) {
      ...
      var arr = header.split(";"), charset = "utf8", found;
      if (arr.length > 1 && (found = arr[1].match(/charset=(.+)/)))
        charset = found[1];
      return { charset, type: arr[0] };
    }
    ...
    Needle.prototype.start = function() {
      var callback = typeof this.options == "function" ? this.options : this.callback, data = this.data, method = this.method, options = this.options || {}, out = new stream.PassThrough({ objectMode: false }), uri = this.uri;
      if (uri.indexOf("http") === -1)
        uri = uri.replace(/^(\/\/)?/, "http://");
      var body, config = this.setup(uri, options), self2 = this, waiting = false;
    ...
    Needle.prototype.send_request = function(count, method, uri, config, post_data, out, callback) {
      ...
      var request_opts = this.get_request_opts(method, uri, config), protocol = request_opts.protocol == "https:" ? https : http, request, returned = 0, self2 = this, timer;
      ...
      request = protocol.request(request_opts, function(resp) {
        ...
        var mime = parse_content_type(headers["content-type"]), pipeline = [], text_response = mime.type && (mime.type.indexOf("text/") != -1 || !!mime.type.match(/(\/|\+)(xml|json)$/));
    ...
    if (typeof Promise !== "undefined") {
      module.exports = function() {
        var args = [].slice.call(arguments), verb;
        if (args[0].match(/\.|\//))
  ...
  "../../../../../setup-pnpm/node_modules/.bin/store/v11/links/@/lodash.merge/4.6.2/2b189c4d8ef1e950f2ec53d37d17c4ea7b14b11cb9e95d45a3e9d96e9b69e672/node_modules/lodash.merge/index.js"(exports, module) {
    ...
    function createAssigner(assigner) {
      return baseRest(function(object, sources) {
        var length = sources.length, customizer = length > 1 ? sources[length - 1] : void 0, guard = length > 2 ? sources[2] : void 0, index = -1;
    ...
    function overRest(func, start, transform) {
      ...
      return function() {
        var args = arguments, length = nativeMax(args.length - start, 0), array = Array(length), index = -1;
        while (++index < length) {
