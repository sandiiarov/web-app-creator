...
- `lib/`: Baseten model config, Baseten Kimi vision OCR, browser screenshot response registry, cost accounting, anchored HTML document/edit/find/image/SSE helpers, and file-backed project storage (`project-store.ts`).
