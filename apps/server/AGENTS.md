...
- `src/index.ts`: custom Node HTTP server, CORS, `/agent`, `/api/projects*` REST, `/api/screenshot-responses/:requestId`, `/images/:id`, `/api/projects/:id/images/:file`, and `/api/projects/:id/screenshots/:file` routing.
