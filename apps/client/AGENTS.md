...
- Prompt tool calls render as individual collapsible blocks, not grouped clusters. The collapsed header shows a tool icon and possibly truncated call intent instead of the tool name; expanded content includes the full intent and separates summarized args from the result/error.
