...
components:
 ...
 code SCRAPE\_NO\_CACHED\_DATA is returned. Set to 1 to accept any
 ...
 https://asawicki.info/nosense/doc/devices/keyboard/key\_codes.html
 for key codes.
 properties:
 type:
 type: string
 ...
 returns a 404 with error code SCRAPE\_LOCKDOWN\_CACHE\_MISS (the URL is
