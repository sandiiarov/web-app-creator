...
\### Example
 ...
 -H "Authorization: Bearer $FIRECRAWL\_API\_KEY" \
...
\### Example
 ...
 formats=\[{\
 "type": "json",\
 "schema": CompanyInfo.model\_json\_schema()\
 }\],
 ...
 company\_mission: z.string(),
 supports\_sso: z.boolean(),
 is\_open\_source: z.boolean(),
 is\_in\_yc: z.boolean()
 });
 ...
 \`\`\`bash cURL theme={null}
 # No API key needed to get started — add -H "Authorization: Bearer YOUR\_API\_KEY" for higher rate limits:
