...
0.7.4 • Public • Published 9 months ago

- [Readme](https://www.npmjs.com/package/idiomorph?activeTab=readme)
- [Code Beta](https://www.npmjs.com/package/idiomorph?activeTab=code)
- [0 Dependencies](https://www.npmjs.com/package/idiomorph?activeTab=dependencies)
- [20 Dependents](https://www.npmjs.com/package/idiomorph?activeTab=dependents)
- [21 Versions](https://www.npmjs.com/package/idiomorph?activeTab=versions)

# ♻️ Idiomorph

[Permalink: ♻️ Idiomorph](https://www.npmjs.com/package/idiomorph#%EF%B8%8F-idiomorph)
...
[Permalink: id sets](https://www.npmjs.com/package/idiomorph#id-sets)
...
[Permalink: Installing](https://www.npmjs.com/package/idiomorph#installing)
...
[Permalink: Usage](https://www.npmjs.com/package/idiomorph#usage)
...
[Permalink: Options](https://www.npmjs.com/package/idiomorph#options)
...
| `head: {style: 'merge', ...}` | Allows you to control how the `head` tag is merged. See the [head](https://www.npmjs.com/package/idiomorph#the-head-tag) section for more details | `Idiomorph.morph(..., {head:{style:'merge'}})` |
...
[Permalink: Callbacks](https://www.npmjs.com/package/idiomorph#callbacks)
...
[Permalink: The head tag](https://www.npmjs.com/package/idiomorph#the-head-tag)
...
[Permalink: Attribute Based Fine-Grained Head Control](https://www.npmjs.com/package/idiomorph#attribute-based-fine-grained-head-control)
...
[Permalink: Additional Configuration](https://www.npmjs.com/package/idiomorph#additional-configuration)
...
[Permalink: Setting Defaults](https://www.npmjs.com/package/idiomorph#setting-defaults)
...
[Permalink: htmx](https://www.npmjs.com/package/idiomorph#htmx)
...
[Permalink: Configuring Morphing Behavior in htmx](https://www.npmjs.com/package/idiomorph#configuring-morphing-behavior-in-htmx)
...
[Permalink: Performance](https://www.npmjs.com/package/idiomorph#performance)
...
smaller morphs. See the [Performance](https://github.com/bigskysoftware/idiomorph/blob/HEAD/PERFORMANCE.md) document for more details.

## Example Morph

[Permalink: Example Morph](https://www.npmjs.com/package/idiomorph#example-morph)
...
[Permalink: Demo](https://www.npmjs.com/package/idiomorph#demo)

You can see a practical demo of Idiomorph out-performing morphdom (with respect to DOM stability, _not_ performance)
here:

[https://github.com/bigskysoftware/Idiomorph/blob/main/test/demo/video.html](https://github.com/bigskysoftware/Idiomorph/blob/main/test/demo/video.html)
...
[Permalink: Usage in the wild](https://www.npmjs.com/package/idiomorph#usage-in-the-wild)
...
Viewing idiomorph version 0.7.4