...
const MODEL_ICONS: Record<string, ComponentType<{ className?: string }>> = {
  ...
  'anthropic/claude-fable-5.1:nitro': AnthropicIcon,
  ...
  'deepseek/deepseek-v4-flash-vision-exp': DeepseekIcon,
  'deepseek/deepseek-v4-flash-vision-exp:nitro': DeepseekIcon,
  ...
  'openai/gpt-6-astra-pro': OpenaiIcon,
  'openai/gpt-6-astra-pro:nitro': OpenaiIcon,
  'openai/gpt-6-astra:nitro': OpenaiIcon,
  ...
  'qwen/qwen3.8-flash': QwenIcon,
  'qwen/qwen3.8-flash:nitro': QwenIcon,
  ...
  'x-ai/grok-4.6': XaiIcon,
  'x-ai/grok-4.6:nitro': XaiIcon,
  'x-ai/grok-imagine-image-quality': XaiIcon,
  'xiaomi/mimo-v2.5': XiaomiIcon,
  'z-ai/glm-5.2:nitro': GlmIcon,
  'z-ai/glm-5.3-flash': GlmIcon,
  'z-ai/glm-5.3-flash:nitro': GlmIcon,
  'z-ai/glm-5.3:nitro': GlmIcon,
